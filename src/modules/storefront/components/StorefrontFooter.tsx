...
export function StorefrontFooter({
  ...
  return (
    <footer
      ...
      className={cn('mt-5 border-t border-slate-200/90 bg-[#f6f8f7]', className)}
    >
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-slate-600 sm:text-xs">
            ...
            <div className="flex items-center gap-1">
              <a
                ...
                className="inline-flex size-7 items-center justify-center rounded-md text-slate-400 transition hover:bg-white hover:text-[var(--store-theme,var(--md-green-700))]"
              >
